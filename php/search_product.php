...
$productFound = true; // Flag to track whether the product is found
...
<div class="main">
    <div style="width: 700px;">
        ...
        <?php if ($productFound && (($inventoryResult && mysqli_num_rows($inventoryResult) > 0) || ($orderResult && mysqli_num_rows($orderResult) > 0) || ($reviewResult && mysqli_num_rows($reviewResult) > 0))) : ?>

            <h2>'<?php echo $productName; ?>'에 대한 제품 정보</h2>

            <?php if ($inventoryResult && mysqli_num_rows($inventoryResult) > 0) : // 재고 결과가 있는 경우에만 아래의 내용을 표시 ?>
